...
<html>
  ...
  <head>
    <title> About | Food's corner </title>
  </head>
    ...
    <nav class="navbar navbar-inverse navbar-fixed-top navigation-clean-search" role="navigation">
      <div class="container">
        <div class="navbar-header">
          ...
          <a class="navbar-brand" href="index.php">Food's corner</a>
        </div>
...
?>
    ...
    <div class="wide">
        ...
        <h3 style="color: red"><center>About the food culture in Food's corner</center></h3>
        <br>
